...
- [hackerFish/dsh-voice-input](https://github.com/hackerFish/dsh-voice-input) —— DSH 语音输入插件：对话框麦克风按钮，浏览器内置 Web Speech API（zh-CN）识别中文语音，说完自动填入输入框草稿——零配置、零密钥，Chrome/Edge 即开即用。
