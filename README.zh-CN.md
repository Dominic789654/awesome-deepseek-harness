...
- [2501136589/dsh-rewind](https://github.com/2501136589/dsh-rewind) — DSH回退插件。
...
- [fancydirty/dsh-dynamic-skin](https://github.com/fancydirty/dsh-dynamic-skin) — Agent 驱动的 DeepSeek Harness web UI 动态背景皮肤插件。
