...
- [hackerFish/dsh-voice-input](https://github.com/hackerFish/dsh-voice-input) — DeepSeek Harness voice-input plugin: a mic button in the composer, browser-native Web Speech API (zh-CN) transcribes Chinese speech straight into the draft — zero config, zero keys, works out of the box in Chrome/Edge.
