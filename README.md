...
- [nickhelion/dsh-qwen-token-plan-cn-responses](https://github.com/nickhelion/dsh-qwen-token-plan-cn-responses) — Qwen Token Plan CN Personal Responses API provider with official model/tool catalog sync, server-side built-in tools, DSH local functions, and image input.
...
- [Dongfang81/dsh-music](https://github.com/Dongfang81/dsh-music) — The first truly AI-native music player: say what song you want in chat and Moony searches, curates, and plays it across the whole web; ten moon pets dance along to the music. Zero-dependency install, a DSH plugin.
...
- [Dongfang81/moony-singer](https://github.com/Dongfang81/moony-singer) — AI-native music player: say a song you want to hear and Moony searches, curates, and plays it across the web, with ten dancing moon-pet companions. Zero-dependency install, DSH plugin.
