...
- [GM-HZ/agent-dag-workflow](https://github.com/GM-HZ/agent-dag-workflow) — Host-neutral durable DAG workflows for agents: CLI-native access, fixed MCP gateway, on-demand Skills, triggers, replay, and a visual Canvas.
