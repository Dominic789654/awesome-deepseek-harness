...
- [EternalNight996/dsh-desktop](https://github.com/EternalNight996/dsh-desktop) — DeepSeek Harness desktop workbench: double-click to use, 255+ pixel-expert plugins that can be installed with one click.
