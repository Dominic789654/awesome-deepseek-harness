...
- [Freakz2z/dsh-catgirl-plugin](https://github.com/Freakz2z/dsh-catgirl-plugin) — A token-efficient persona runtime for DeepSeek Harness. Measured: -67% input tokens, -66% cache reads, 0-token catgirl rendering.
