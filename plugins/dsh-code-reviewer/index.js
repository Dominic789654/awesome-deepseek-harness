/**
 * dsh-code-reviewer bundle entry: registers the packaged
 * `skills/code-review/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-code-reviewer
 */
...
const PROVIDER_NAME = 'dsh-code-reviewer'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-code-reviewer'
